...
const ITEMS: SearchItem[] = [
  ...
  { label: 'Fichas Equipos', href: '/equipos', category: 'Operacional', icon: '🏗', keywords: ['proveedor', 'capex', 'opex', 'mantencion'] },
  { label: 'Análisis PEF A/B', href: '/pef-analisis', category: 'Operacional', icon: '⚡', keywords: ['justificacion', 'arriendo', 'sin pef'] },
  { label: 'Balance Energía', href: '/balance-energia', category: 'Operacional', icon: '⚡', keywords: ['kwh', 'mix renovable', 'factor potencia'] },
